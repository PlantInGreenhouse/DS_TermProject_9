...
data_cleaned['experience_level'] = label_encoder.fit_transform(data_cleaned['experience_level'])
data_cleaned['company_size'] = label_encoder.fit_transform(data_cleaned['company_size'])
...
data_cleaned['remote_ratio'] = minmax_scaler.fit_transform(data_cleaned[['remote_ratio']])
...
preprocessed_data_df.to_csv('termproject/preprocessed_data.csv', index=False)
