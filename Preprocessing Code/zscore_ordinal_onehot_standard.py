...
# Remove outliers using the z-score method for 'salary_in_usd'
...
data_cleaned['remote_ratio'] = standard_scaler.fit_transform(data_cleaned[['remote_ratio']])
...
preprocessed_data_df.to_csv('termproject/preprocessed_data_standardized.csv', index=False)
